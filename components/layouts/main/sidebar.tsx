...
function SideBar() {
  ...
  const isRouteActive = (menuLink: string) => {
    // For dashboard, we want exact match only
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen ? (
          <div className="mt-auto mx-auto w-[192px] shadow-2xl border rounded-[20px] py-7 px-[23px] my-6 bg-orange-200 bg-[url('/assets/images/Ellipse 128.svg'),url('/assets/images/Ellipse 129.svg')] bg-[left_top,right_bottom] bg-[auto,auto] flex flex-col gap-8 items-center">
