...
const DedicatedNumber: React.FC<BaseTableProps>  =  ({data})=>{
                    ...
                    <DropdownMenuTrigger asChild>
                        {row.payment === "paid" ? (
                            <Button
                                ...
                                size="icon" variant="ghost" className='w-[7rem]  py-1  border border-green-500 hover:bg-green-200 rounded-2xl '>
            ...
            <div className="p-8 max-w-5xl  bg-gray-50 min-h-screen">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                    ...
                    <div className=" flex gap-3">
                        <h1 className="text-text font-semibold text-2xl">Dedicated Number</h1>
                    </div>
...
export default DedicatedNumber